  ...
  return (
    <div className="w-full max-w-screen-2xl mx-auto px-4 sm:px-6 md:px-8 my-8">
      ...
      <div className="my-16 flex flex-col items-center gap-8">
        <h1 className="font-inter font-semibold text-xl sm:text-2xl md:text-3xl lg:text-4xl text-[#272343] text-center">
          What Makes Our Brand Different
        </h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-6 w-full">
          {[
            {
              icon: <TbTruckDelivery className="text-[#007580] text-3xl" />,
            ...
            {
              icon: (
                <IoIosCheckmarkCircleOutline className="text-[#007580] text-3xl" />
              ),
            ...
            {
              icon: <CreditCard className="text-[#007580] text-3xl" />,
              title: "Unbeatable prices",
              description:
                "For our materials and quality you won’t find better prices anywhere",
            },
            {
              icon: <LuSprout className="text-[#007580] text-3xl" />,
            ...
            >
              {item.icon}
              <h2 className="font-inter font-semibold text-base sm:text-lg md:text-xl lg:text-2xl text-[#007580]">
                {item.title}
              </h2>
      ...
      <div className="max-w-[1440px] mx-auto px-4 my-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-8 gap-6">
          ...
          <div className="md:col-span-2 lg:col-span-4 grid grid-cols-1 md:grid-cols-2 gap-6">
            {["/Parent.png", "/Parent1.png"].map((image, index) => (
              <div key={index}>
                <Image
                  src={image}
                  alt={`The Dandy Chair ${index + 1}`}
                  width={720} // Explicit width
